...
export const slidOverInjectionKey: InjectionKey<ShallowRef<SlideoverState>> = Symbol('app-ui.slideover')
...
function _useSlideover() {
   ...
   */
  function patch<T extends Component = object>(props: Partial<Slideover & ComponentProps<T>>) {
    if (!slideoverState) return
