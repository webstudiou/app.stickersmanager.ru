...
setCrumbs([
  ...
  { name: 'pages.settings.imports.index.headings.title' },
])

setTitle('pages.settings.imports.index.headings.title')

useHead({
  title: useLangs('pages.settings.imports.index.headings.title'),
})
</script>
