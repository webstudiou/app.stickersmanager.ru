...
setCrumbs([
  ...
  { name: 'pages.settings.integrations.index.headings.title' },
])

setTitle('pages.settings.integrations.index.headings.title')

useHead({
  title: useLangs('pages.settings.integrations.index.headings.title'),
})
</script>
